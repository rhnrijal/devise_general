...
class TalentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create talent" do
    assert_difference('Talent.count') do
      post talents_url, params: { talent: { experience: @talent.experience, name: @talent.name } }
    end
  ...
  test "should update talent" do
    patch talent_url(@talent), params: { talent: { experience: @talent.experience, name: @talent.name } }
